...
require_once('./db.conf.php'); 
 $query= "insert into venue (event,event1, people,budget,date,Srequest,name,email,number,description,status)
 VALUES ('$_POST[event]','$_POST[event1]','$_POST[people]','$_POST[Budget]','$_POST[date]','$_POST[sreq]','$_POST[name]','$_POST[email]','$_POST[phonenum]','$_POST[dcomment]','Not confirmed')";
...
<h1>Request Pricing</h1>
     ...
     <table>           
           ...
           <tr>
             ...
             <td> 
                <textarea rows="5" cols="30" id="sreq" name="sreq"   require>
                </textarea>
               </td>
           </tr>
           <br>
                  ...
                  <tr>
                     <td>Phone Number (format: xxx-xxx-xxxx):</td>
                     <td><input id="phonenum" name="phonenum" type="tel" require></td>
                  </tr>           
                  <tr>
